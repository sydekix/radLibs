...
// function altHistoryText() {
//     let altHistoryMsg = '<h2>One of them thar "What If?"ers, eh? Sweet!</h2>';
//     let altHistoryDiv = document.createElement('div');
//     altHistoryDiv.innerHTML = altHistoryMsg;
//     document.body.appendChild(altHistoryDiv);
//     inputNouns();
...
// altHistoryButton.addEventListener('click', altHistoryText);
...
/* brentNotes - Thinking through this section! 

Try this - Write a function that creates a mini-form. (Not sure if I need a whole form for this; I may try without it at first.) This function will get called when the user chooses their genre. (Trying this.) This mini-form will have a submit button, that——when pressed——will store the values into an array AND call for the next part of the form. 

To make things easier on myself (hopefully), I'm going to use the same number of sentence parts for each story for now. (Maybe this will limit the number of arrays I have and code I have to write.) */
...
// ---------------------------------------------------------------------
// UNUSED/SCRAP CODE
// sciFiButton.onclick = function() {

// }

// sciFiButton.addEventListener ('click', ()=>{
//     var text = document.createTextNode("Excellent! Sci-Fi it is!");
//     p.output.appendChild(text);
// })

// sciFiButton.addEventListener('click', ()=>{
//     var sciFiMsg = '<h2>Excellent! Sci-Fi it is!</h2>';
//     var sciFiDiv = document.createElement('div');
//     sciFiDiv.innerHTML = sciFiMsg;
//     document.body.appendChild(sciFiDiv);
// })
